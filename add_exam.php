...
<form role="form" class="form-horizontal" style="margin-top: 20px;">
  ...
  <div class="tab-pane fade" id="students">
  	...
  	<label for="duration" class="col-sm-12 control-label" style="margin-left: 0px; padding-left: 0px;">Format: imię nazwisko &lt;adres e-mail&gt;</label>
  	<div class="container col-md-12">
