...
<thead>
		...
		<th>Nazwisko</th>
		<th>E-mail</th>
		<th style="text-align:center; vertical-align:middle;">Opcje</th>
		</tr>
...
<?php
	...
	foreach ($studentList as $number => $student) {
		...
		echo '<td style="text-align:center; vertical-align:middle;"><span id="edit" style="cursor: pointer;" data-toggle="tooltip" data-placement="bottom" title="Edit" class="glyphicon glyphicon-pencil"></span><span id="remove" data-toggle="tooltip" data-placement="bottom" title="Remove" class="glyphicon glyphicon-remove" style="margin-left: 10%; cursor: pointer;"></span></td>';
		echo '</tr>';
